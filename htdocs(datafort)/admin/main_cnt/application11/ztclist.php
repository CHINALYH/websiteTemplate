...
<body>
    <div id="admin_cnt">
        <ul class="menu_breadcrumbs">
            <li>当前位置：</li>
            <li>应用模块 >> 广告模块 >>  直通车列表</li>
            <li id="back"><a href="javascript:history.go(-1);"><span>返回</span></a></li>
        </ul>
        <ul class="main_top_menu">
        	<li class="top_menu"><a href="ztclist.php" class="active">直通车列表</a></li>
        	<li class="top_menu"><a href="ztcadd.php">添加直通车</a></li>
        </ul>
    	<div id="admin_cnt_inner">
			<div id="addcnt">
                <table class="table_all">
                  <caption>直通车列表</caption>
                  <thead>
                  	<tr>
                    	<th width="5%" class="style_th">序号</th>
                    	<th width="29%" class="style_th">名称</th>
                    	<th width="15%" class="style_th">缩略图</th>
                    	<!--<th width="15%" class="style_th">缩略图</th>-->
                        <th width="10%" class="style_th">是否属于直通车</th>
                        <th width="10%" class="style_th">显示位置</th>
                        <th width="10%" class="style_th">启用状态</th>
                        <th colspan="2" class="style_th">操作</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                  	$sql = "select * from `advert_info` where type_id = 2 and ztc=1 order by addtime desc";
					$result = $mysqli->query($sql);
					$i=0;
				  ...
				  ?>
                    ...
                    <!--  <td class="style_td">
                      	<a href="<?php echo $row['linkurl']?>" target="_blank">
                      		<img src="<?php echo $row['linkpicmore']?>" height="45" />
                        </a>
                      </td>-->
                       <td class="style_td">
                     	<?php
                      ...
                      <a href="ztceditor.php?id=<?php echo $row['id'];?>">编辑</a></td>
